...
class __TwigTemplate_0b195302445bbc9c1f36210c3d1bae04 extends Template
{
...
(isset($context["__internal_3d16268c3e866c1ba9a4914d894bbe33c12c35ebebf8bb730a2d5e7e1c4dc2f5"]) || array_key_exists("__internal_3d16268c3e866c1ba9a4914d894bbe33c12c35ebebf8bb730a2d5e7e1c4dc2f5", $context) ? $context["__internal_3d16268c3e866c1ba9a4914d894bbe33c12c35ebebf8bb730a2d5e7e1c4dc2f5"] : (function () { throw new RuntimeError('Variable "__internal_3d16268c3e866c1ba9a4914d894bbe33c12c35ebebf8bb730a2d5e7e1c4dc2f5" does not exist.', 2, $this->source); })())), "html", null, true);
                    // line 108
                    yield "
                                    </a>
                                ";
    ...
    public function block_responsive_header(array $context, array $blocks = []): iterable
    {
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 195, $this->source); })()), "userMenu", [], "any", false, false, false, 195), "avatarDisplayed", [], "any", false, false, false, 195)) {
            ...
            // line 198
            yield "                                    ";
            yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("ea:Icon", ["class" => "user-avatar", "name" => (( !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 198, $this->source); })()), "user", [], "any", false, false, false, 198))) ? ("inernal:user") : ("internal:user-xmark"))]);
            yield "
                                ";
        }
        // line 200
                        ...
                        <div class=\"dropdown user-menu-wrapper {{ is_granted(impersonator_permission) ? 'user-is-impersonated' }} ms-auto\">
                            <a class=\"user-details\" type=\"button\" data-bs-toggle=\"dropdown\" data-bs-offset=\"0,5\" aria-expanded=\"false\">
                                ...
                                {% if ea.userMenu.avatarDisplayed %}
                                    {{ user_menu_avatar }}
                                {% else %}
                                    {{ component('ea:Icon', { class: 'user-avatar', name: (ea.user is not null ? 'inernal:user' : 'internal:user-xmark') }) }}
                                {% endif %}
                            </a>
