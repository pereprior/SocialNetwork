...
return [
    ...
    [ // $dynamicRoutes
        ...
        183 => [[['_route' => 'post_like', '_controller' => 'App\\Controller\\PageController::like'], ['id'], null, null, false, true, null]],
        205 => [
            [['_route' => 'post_info', '_controller' => 'App\\Controller\\PostController::post'], ['id'], null, null, false, true, null],
